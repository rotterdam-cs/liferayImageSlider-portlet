...
<link rel="stylesheet" href="<%=renderRequest.getContextPath()%>/css/rcs-slider.css" type="text/css" media="screen" />

<script type="text/javascript">
	$(window).load(function() {
	    $('#slider').rcsSlider({<%=buildSettings%>});
	});
</script>
